    ...
    >
      <div className="max-w-8xl mx-auto px-8 sm:px-6 lg:px-8">
        <div className="relative flex items-center justify-between h-16 sm:h-20 lg:h-24">
          ...
          <div className="hidden lg:flex items-center gap-4 xl:gap-14 absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2">
          ...
          {/* Desktop CTA Button */}
          <div className="hidden lg:flex items-center gap-1.5 xl:gap-4 z-10">
            {isAuthenticated ? (
              <>
                <Link href="/dashboard">
                  <PrimaryButton
                    text="Dashboard"
                    className="px-2.5 xl:px-8"
                    icon={User}
                  />
                </Link>
                <PrimaryButton
                  text="Logout"
                  className="px-2.5 xl:px-8 bg-red-600 hover:bg-red-500"
                  onClick={logout}
                  icon={LogOut}
                />
              </>
